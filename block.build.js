...
registerBlockType('codepen/codepen-embed', {
	...
	edit: function edit(_ref) {
		...
		return [focus && wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					'label',
					{ htmlFor: 'blocks-codepen-embed-control-pen-height', className: 'blocks-base-control__label' },
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					'label',
					{ htmlFor: 'blocks-codepen-embed-control-pen-theme-id', className: 'blocks-base-control__label' },
					__('Theme ID:', 'codepen')
				),
				wp.element.createElement('input', { // eslint-disable-line jsx-a11y/no-onchange
	...
	save: function save(_ref5) {
		...
		return wp.element.createElement(
			...
			wp.element.createElement(
				'p',
				{ className: 'codepen', 'data-height': penHeight, 'data-theme-id': themeID, 'data-slug-hash': penID, 'data-default-tab': 'result', 'data-animations': 'stop-after-5' },
				content
			),
			wp.element.createElement('script', { async: true, src: '//codepen.io/assets/embed/ei.js' })
		);
	}
});
...
var TextareaAutosize_1 = __webpack_require__(10);
...
var autosize = __webpack_require__(17);
var _getLineHeight = __webpack_require__(18);
